use grayline_sstv::{mode::Mode, time::SstvDuration};
use grayline_sstv_fskid::{FskId, FskNumber, FskRecord};
...
impl DemodulatedChunk {
    ...
    pub fn block_from(&self, offset: usize) -> grayline_sstv::rx::DemodulatedBlock<'_> {
        grayline_sstv::rx::DemodulatedBlock::new(
