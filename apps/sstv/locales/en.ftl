...
section-rx-state = Receive state
...
contact-note-keys = A template reads these as ${ "{" }contact.name{ "}" }. Anything you type here is yours; no lookup will overwrite it.
